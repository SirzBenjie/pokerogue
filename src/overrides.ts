...
const overrides = {
  ...
  STARTER_SPECIES_OVERRIDE: SpeciesId.NECROZMA,
  ITEM_REWARD_OVERRIDE: [{ name: "RARE_FORM_CHANGE_ITEM" }, { name: "FORM_CHANGE_ITEM" }],
  STARTING_HELD_ITEMS_OVERRIDE: [
    { name: "LEFTOVERS" },
    { name: "ATTACK_TYPE_BOOSTER", type: PokemonType.PSYCHIC },
    { name: "EVIOLITE" },
    { name: "WIDE_LENS" },
    { name: "TOXIC_ORB" },
    { name: "SPECIES_STAT_BOOSTER", type: "QUICK_POWDER" },
    { name: "BATON" },
    { name: "SOUL_DEW" },
    { name: "WHITE_HERB" },
    { name: "SHELL_BELL" },
    ...
    { name: "SCOPE_LENS" },
    { name: "FOCUS_BAND" },
    { name: "BASE_STAT_BOOSTER", type: Stat.ATK, count: 2 },
    { name: "GOLDEN_EGG" },
    { name: "LUCKY_EGG" },
    { name: "QUICK_CLAW" },
    { name: "GOLDEN_PUNCH" },
  ...
  STARTING_MODIFIER_OVERRIDE: [
    { name: "EXP_SHARE" },
    { name: "CANDY_JAR", count: 4 },
    { name: "MAP" },
    { name: "LURE", count: 5 },
    { name: "MAX_LURE", count: 5 },
    { name: "SUPER_LURE", count: 5 },
    { name: "SUPER_EXP_CHARM", count: 5 },
    { name: "TERA_ORB" },
    { name: "DYNAMAX_BAND" },
    { name: "BERRY_POUCH", count: 3 },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.ATK },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.DEF },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.ACC },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.SPDEF },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.SPD },
    { name: "TEMP_STAT_STAGE_BOOSTER", type: Stat.SPATK },
    { name: "DIRE_HIT", count: 5 },
    { name: "GOLDEN_EXP_CHARM", count: 5 },
    { name: "GOLDEN_POKEBALL", count: 2 },
    { name: "CATCHING_CHARM", count: 2 },
    { name: "ABILITY_CHARM", count: 1 },
    { name: "IV_SCANNER" },
    { name: "HEALING_CHARM", count: 2 },
    { name: "LOCK_CAPSULE" },
    { name: "MYSTERY_ENCOUNTER_GOLDEN_BUG_NET" },
    { name: "AMULET_COIN" },
  ],
